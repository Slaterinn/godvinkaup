import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, toRef, isRef, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw, withCtx } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/ufo/dist/index.mjs';
import { defuFn, createDefu, defu } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/defu/dist/defu.mjs';
import { klona } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/klona/dist/index.mjs';
import { extendTailwindMerge } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/beer-c232023b.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-b346fe7b.mjs').then((m) => m.default || m)
  },
  {
    name: "wine",
    path: "/wine",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/wine-7204650b.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-0a5d12be.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-06006445.mjs').then((r) => r.default));
...
const layouts = {
  custom: () => import('./_nuxt/custom-c793921f.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-bd44188b.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-48dacb60.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useAppConfig as a, appConfig as b, createError as c, useRoute as d, entry$1 as default, useRouter as e, useNuxtApp as f, asyncDataDefaults as g, fetchDefaults as h, useState as i, useRuntimeConfig as j, navigateTo as k, mergeConfig as m, nuxtLinkDefaults as n, useHead as u };
