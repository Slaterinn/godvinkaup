import __nuxt_component_0$4 from './Icon-0a5d12be.mjs';
import { a as useAppConfig, m as mergeConfig, b as appConfig, u as useHead, _ as _export_sfc } from '../server.mjs';
import { defineComponent, computed, useSSRContext, toRef, ref, toRefs, useAttrs, toValue, getCurrentInstance, inject, onUnmounted, withCtx, createVNode, toDisplayString, mergeProps, resolveDynamicComponent, renderSlot, openBlock, createBlock, createCommentVNode } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrRenderList } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_0$5 } from './nuxt-link-b2e5ab4b.mjs';
import { isEqual } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/ohash/dist/index.mjs';
import { twMerge, twJoin } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { useScroll, useElementSize, useResizeObserver } from 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/@vueuse/core/index.mjs';
import 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/@iconify/vue/dist/offline.mjs';
import 'file://C:/Users/lamthp/Documents/NUXT/godvinkaup/node_modules/@iconify/vue/dist/iconify.mjs';
import './index-7a71a440.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const items1 = [{
      ...
      description: "\xC1vaxtar\xEDkt en samt dj\xFAprautt v\xEDn fr\xE1 fj\xF6lskyldufyrirt\xE6kinu F\xE9lix Sol\xEDs. \xDEetta v\xEDn n\xE6r jafnv\xE6gi \xE1 milli \xFEess a\xF0 vera \xFEurrt og s\xE6tt en \xFEa\xF0 m\xE1 b\xFAast vi\xF0 \xFEv\xED a\xF0 finna keim af vanillu, eik og t\xF3baki auk \xFEess hefur \xFEa\xF0 s\xE6tan keim af rau\xF0um kirsuberjum og pl\xF3mu.",
      seller: "\xC1TVR",
      price: "2.599 kr",
      ...
      description: "\xDEurrt og s\xFArt hv\xEDtv\xEDn sem hefur ferskan \xE1vaxtailm og brag\xF0 af s\xEDtrus, greip og \xE1staraldin.",
      seller: "\xC1TVR",
      price: "2.799 kr",
      grapes: "Sauvignon Blanc",
      country: "N\xFDja-Sj\xE1land"
    }, {
      name: "Torre Mora Scalunera Etna Rosato",
      img: "https://images.vivino.com/thumbs/SWRDzZF1RWyMhSPMdyAcMA_pb_x600.png",
      description: "\xD3v\xE6nt en k\xE6rkomin hl\xFDja og krydd einkenna lyktina af \xFEessu f\xF6lbleika r\xF3sav\xEDni sem hefur brag\xF0 af s\xEDtrus\xE1v\xF6xtum \xED bland vi\xF0 m\xE1lm- og saltkeim. ",
      seller: "\xC1TVR",
      price: "3.499 kr",
    ...
    const items2 = [{
      ...
      description: "D\xF6kkkirsuberjarautt, \xFE\xE9tt og miki\xF0 v\xEDn fr\xE1 Puglia \xE1 \xCDtal\xEDu. V\xEDni\xF0 100% \xFAr negroamaro \xFEr\xFAgunni sem gefur \xFEv\xED ekki bara d\xF6kkan lit heldur brag\xF0 af br\xF3mberjum og \xFEurrku\xF0u kryddi eins og bl\xF3\xF0bergi.",
      seller: "\xC1TVR",
      price: "3.716 kr",
      ...
      description: "Skemmtilegt v\xEDn fr\xE1 Su\xF0ur-Afr\xEDku me\xF0 undirliggjandi kryddbrag\xF0 og rifsberjakeim. V\xEDn me\xF0 miki\xF0 body og eftirbrag\xF0 sem situr lengi eftir. Hentar vel me\xF0 rau\xF0u kj\xF6ti.",
      seller: "\xC1TVR",
      price: "3.995 kr",
      grapes: "Syrah 73%, Grenache 11%, Cinsault 8%, Cabernet Sauvignon 7%, Viognier 1%",
      country: "Su\xF0ur-Afr\xEDka"
    }, {
      name: "2011 Vi\xF1a Bosconia Tinto Reserva",
      img: "https://images.vivino.com/thumbs/eDyHmY-EQcG28_Ezlpgq5A_pb_x600.png",
      description: "\xDEetta v\xEDn hefur yfir meira en \xE1ratug \xFEr\xF3ast yfir \xED dj\xFApan rau\xF0an lit me\xF0 \xF6rl\xEDtilli appels\xEDnugulu. Lyktin ber me\xF0 s\xE9r \xE1genga \xE1vexti og brag\xF0i\xF0 er \xFE\xE9tt, mj\xFAkt og f\xEDnt (\xFEetta er ekki l\xFDsing \xE1 r\xFAminu m\xEDnu)",
      seller: "Sante",
      price: "4.900 kr",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="h-screen w-100 flex justify-center items-center"><div class="max-w-4xl md:w-full font-teko"><div class="text-2xl font-montserrat mb-10 text-center text-[#FDA47E]"><h3>Ver\xF0ur a\xF0 pr\xF3fa</h3></div>`);
      _push(ssrRenderComponent(_component_UCarousel, {
        ...
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", item.img)}${ssrRenderAttr("alt", item.name)} draggable="false" class="ml-[10%]"${_scopeId}><div class="grid grid-cols-1 gap-3 mx-[10%]"${_scopeId}><h2 class="text-5xl font-medium"${_scopeId}>${ssrInterpolate(item.name)}</h2><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.seller)}</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>S\xD6LUA\xD0ILI</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.price)}</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>VER\xD0</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>\xCDtal\xEDa</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>LAND</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>4.2</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>EINKUNN</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.grapes)}</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>\xDER\xDAGUR</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.description)}</span></div><div${_scopeId}><span class="text-md text-lg text-[#7a7a7a]"${_scopeId}>L\xDDSING</span></div></div></div>`);
          } else {
            return [
              createVNode("img", {
                src: item.img,
              ...
              createVNode("div", { class: "grid grid-cols-1 gap-3 mx-[10%]" }, [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-lg text-[#7a7a7a]" }, "S\xD6LUA\xD0ILI")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-lg text-[#7a7a7a]" }, "VER\xD0")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-xl" }, "\xCDtal\xEDa")
                  ]),
                  createVNode("div", null, [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-lg text-[#7a7a7a]" }, "\xDER\xDAGUR")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-lg text-[#7a7a7a]" }, "L\xDDSING")
                  ])
                ])
              ])
            ];
      ...
      _push(ssrRenderComponent(_component_UCarousel, {
        ...
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", item.img)}${ssrRenderAttr("alt", item.name)} draggable="false" class="ml-[10%]"${_scopeId}><div class="grid grid-cols-1 gap-3 mx-[10%]"${_scopeId}><h2 class="text-5xl font-medium"${_scopeId}>${ssrInterpolate(item.name)}</h2><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.seller)}</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>S\xD6LUA\xD0ILI</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.price)}</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>VER\xD0</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>\xCDtal\xEDa</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>LAND</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>4.2</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>EINKUNN</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.grapes)}</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>\xDER\xDAGUR</span></div></div><div${_scopeId}><div${_scopeId}><span class="text-md text-xl"${_scopeId}>${ssrInterpolate(item.description)}</span></div><div${_scopeId}><span class="text-md text-[#7a7a7a]"${_scopeId}>L\xFDsing</span></div></div></div>`);
          } else {
            return [
              createVNode("img", {
                src: item.img,
              ...
              createVNode("div", { class: "grid grid-cols-1 gap-3 mx-[10%]" }, [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-[#7a7a7a]" }, "S\xD6LUA\xD0ILI")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-[#7a7a7a]" }, "VER\xD0")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-[#7a7a7a]" }, "\xDER\xDAGUR")
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("div", null, [
                  ...
                  createVNode("div", null, [
                    createVNode("span", { class: "text-md text-[#7a7a7a]" }, "L\xFDsing")
                  ])
                ])
              ])
            ];
...
//# sourceMappingURL=index-b346fe7b.mjs.map
