...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/beer-c232023b.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-b346fe7b.js").then((m) => m.default || m)
  },
  {
    name: "wine",
    path: "/wine",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/wine-7204650b.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-0a5d12be.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-06006445.js").then((r) => r.default));
...
const layouts = {
  custom: () => import("./_nuxt/custom-c793921f.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-bd44188b.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-48dacb60.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-7e054862.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-842404a8.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
